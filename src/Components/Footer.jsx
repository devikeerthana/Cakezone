...
const Footer = () => {
  return (
    <>
      <section className='footer mt-5 mb-0'>
          ...
          <div className='row m-0'>
            ...
            <div className='col-lg-3 col-md-6 col-sm-7 col-12'>
              <div className='footer-box orange-box text-white '>
                ...
                <p className='para3'>Lorem diam sit erat dolor elitr et, diam lorem
                  justo labore amet clita labore stet eos magna sit. Elitr dolor eirmod
                  duo tempor lorem, elitr clita ipsum sea. Nonumy rebum et takimata
                  ea takimata amet gubergren, erat rebum magna lorem stet eos. Diam amet et kasd eos duo dolore no.</p>
              </div>
            </div>
